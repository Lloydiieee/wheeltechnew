        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_fn" name="inp_fn"
                    placeholder="Enter (Required) First Name here.. " value="{{ $info->applicant_first_name ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_mn" name="inp_mn"
                    placeholder="Enter (Required) Middle Name here.. " value="{{ $info->applicant_middle_name ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_ln" name="inp_ln"
                    placeholder="Enter (Required) Last Name here.. " value="{{ $info->applicant_last_name ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_alias" name="inp_alias"
                    placeholder="Enter (Required) Alias here.. " value="{{ $info->applicant_alias ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap focused">
                ...
                <input required type="text" data-date-format="yyyy-mm-dd" placeholder="YYYY-MM-DD" id="inp_dob"
                    name="inp_dob" class="form-control date-picker" value="{{ $info->applicant_birthdate ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_pob" name="inp_pob"
                    ...
                    value="{{ $info->applicant_birthplace ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <select name="inp_cs" id="inp_cs" class="form-select" required>
            ...
            <script>
                document.getElementById('inp_cs').value = '{{ $info->applicant_civil_status ?? '' }}';
            </script>
        </div>
        <div class="col-lg-2">
        ...
        <div class="col-lg-4">
            ...
            <select name="inp_gender" id="inp_gender" class="form-select" required>
                <option value="" data-select2-id="3" style="text-transform: uppercase !important;">- SELECT
                    GENDER -</option>
            ...
            <script>
                document.getElementById('inp_gender').value = '{{ $info->applicant_gender ?? '' }}';
            </script>
        </div>
    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_pn" name="inp_pn"
                    ...
                    value="{{ $info->applicant_phone_number ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_tn" name="inp_tn"
                    ...
                    value="{{ $info->applicant_telephone_number ?? '' }}">
            </div>
        ...
        <div class="col-lg-10">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_dl" name="inp_dl"
                    ...
                    value="{{ $info->applicant_license ?? '' }}">
            </div>

        </div>
    </div>

    <div class="data-head mt-3 mb-3">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="region" name="region"
                    placeholder="Enter  here.. " value="{{ $info->applicant_present_add_region ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="province" name="province"
                    placeholder="Enter  here.. " value="{{ $info->applicant_present_add_province ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="province" name="province"
                    placeholder="Enter  here.. " value="{{ $info->applicant_present_add_municipal ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="brgy" name="brgy"
                    placeholder="Enter  here.. " value="{{ $info->applicant_present_add_barangay ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_pahns" name="inp_pahns"
                    ...
                    value="{{ $info->applicant_present_add_house_number ?? '' }}">
            </div>
        ...
        <div class="col-lg-1">
            ...
            <div class="form-control-wrap">
                <input required type="text" class="form-control" id="inp_palos" name="inp_palos"
                    placeholder="0000" value="{{ $info->applicant_present_add_length_service ?? '' }}">
            </div>
        ...
        <div class="col-lg-1">
            ...
            <div class="form-group">
                <label class="form-label" for="inp_pazc" style="font-size: 13px">Zip Code <b
                        class="text-danger">*</b></label>
                <span class="form-note">Zip Code.</span>
            </div>
        ...
        <div class="col-lg-2">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_pazc" name="inp_pazc"
                    ...
                    value="{{ $info->applicant_present_add_zip_code ?? '' }}">
            </div>
    ...
    <div class="data-head mt-3 mb-3">
        <h6 class="overline-title">Previous Address</h6>
    </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="region_previous" name="region_previous"
                    placeholder="Enter  here.. " value="{{ $info->applicant_relative_relationship ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="province_previous" name="province_previous"
                    placeholder="Enter  here.. " value="{{ $info->applicant_previous_add_region ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        <div class="col-lg-2">
            ...
            <div class="form-group">
                <label class="form-label" for="citymun_previous">City or Municipality <b
                        class="text-danger">*</b></label>
                <span class="form-note">Specify here.</span>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="citymun_previous" name="citymun_previous"
                    placeholder="Enter  here.. " value="{{ $info->applicant_previous_add_province ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="brgy_previous" name="brgy_previous"
                    placeholder="Enter  here.. " value="{{ $info->applicant_previous_add_municipal ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_prehns" name="inp_prehns"
                    placeholder="Enter (Required) House No. Street here.. "
                    value="{{ $info->applicant_previous_add_barangay ?? '' }}">
            </div>
        ...
        <div class="col-lg-1">
            ...
            <div class="form-control-wrap">
                <input required type="text" class="form-control" id="inp_prelos" name="inp_prelos"
                    placeholder="0000" value="{{ $info->applicant_previous_add_length_service ?? '' }}">
            </div>
        ...
        <div class="col-lg-1">
            ...
            <div class="form-group">
                <label class="form-label" for="inp_prezc" style="font-size: 13px">Zip Code <b
                        class="text-danger">*</b></label>
                <span class="form-note">Zip Code.</span>
            </div>
        ...
        <div class="col-lg-2">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_prezc" name="inp_prezc"
                    placeholder="Enter (Required) Zip Code here.. "
                    value="{{ $info->applicant_previous_add_zip_code ?? '' }}">
            </div>
    ...
    <div class="data-head mt-3 mb-3">
        <h6 class="overline-title"> Provincial Addresss</h6>
    </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="region_provincial" name="region_provincial"
                    placeholder="Enter  here.. " value="{{ $info->applicant_provincial_add_region ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="province_provincial"
                    name="province_provincial" placeholder="Enter  here.. "
                    value="{{ $info->applicant_provincial_add_province ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        <div class="col-lg-2">
            ...
            <div class="form-group">
                <label class="form-label" for="citymun_provincial">City or Municipality <b
                        class="text-danger">*</b></label>
                <span class="form-note">Specify here.</span>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="citymun_provincial"
                    name="citymun_provincial" placeholder="Enter  here.. "
                    value="{{ $info->applicant_provincial_add_municipal ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="brgy_provincial" name="brgy_provincial"
                    placeholder="Enter  here.. " value="{{ $info->applicant_provincial_add_barangay ?? '' }}">
            </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_provhns" name="inp_provhns"
                    ...
                    value="{{ $info->applicant_provincial_add_house_number ?? '' }}">
            </div>
        ...
        <div class="col-lg-1">
            ...
            <div class="form-control-wrap">
                <input required type="text" class="form-control" id="inp_provlos" name="inp_provlos"
                    placeholder="0000" value="{{ $info->applicant_provincial_add_length_service ?? '' }}">
            </div>
        ...
        <div class="col-lg-1">
            ...
            <div class="form-group">
                <label class="form-label" for="inp_provzc" style="font-size: 13px">Zip Code <b
                        class="text-danger">*</b></label>
                <span class="form-note">Zip Code.</span>
            </div>
        ...
        <div class="col-lg-2">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_provzc" name="inp_provzc"
                    ...
                    value="{{ $info->applicant_provincial_add_zip_code ?? '' }}">
            </div>
    ...
    <div class="data-head mt-3 mb-3">
        <h6 class="overline-title">Nearest Relative not living with application side</h6>
    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_relname" name="inp_relname"
                    placeholder="Enter (Required) Name here.. " value="{{ $info->applicant_relative_name ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_reladd" name="inp_reladd"
                    ...
                    value="{{ $info->applicant_relative_address ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_relrel" name="inp_relrel"
                    ...
                    value="{{ $info->applicant_relative_relationship ?? '' }}">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-control-wrap">
                ...
                <input required type="text" class="form-control" id="inp_relphone" name="inp_relphone"
                    ...
                    value="{{ $info->applicant_relative_phone_number ?? '' }}">
            </div>
