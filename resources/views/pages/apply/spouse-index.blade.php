                ...
                <div class="card-inner card-inner-lg">
                    <div class="nk-block-head nk-block-head-lg pb-3">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title text-2xl fw-bold">Spouse Information</h4>
                    ...
                    <div class="nk-block">
                        <div class="nk-data data-list">
                            <div class="data-head">
                                <h6 class="overline-title">Spouse Information</h6>
                            </div>
                            <form action="{{route('application.save')}}" method="POST" autocomplete="off">
                                @csrf
